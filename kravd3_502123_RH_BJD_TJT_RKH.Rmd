...
```{r}
ptest <- skadd_oskadd$n_skadd / (skadd_oskadd$n_skadd + skadd_oskadd$n_oskadd)
ptest

# prop.test(x = skadd_oskadd$n_skadd, n = skadd_oskadd$n_oskadd, p = ptest)
prop.test(x = skadd_oskadd)
